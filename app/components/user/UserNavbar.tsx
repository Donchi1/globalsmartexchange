...
export default function AdminNavbar() {
  ...
  const [notifications] = useCollection(noteRefData);

  const [userDocument] = useGetDocument(
    "users",
  ...
  return (
    <>
      ...
      <nav className="bg-sec-bg sticky top-0 py-6 px-0 lg:px-2 shadow-lg z-20">
        <div className="container max-w-full mx-auto flex items-center justify-between px-2 lg:px-8">
