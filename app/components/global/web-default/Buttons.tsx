...
export function IconButton({ title, onClick, className, icon=(<CustomIcon className="w-[30px] h-[30px]" color={6}  icon={<span className="text-g-ancent-text">₿</span>} />) }: ButtonInterface) {
  return (
